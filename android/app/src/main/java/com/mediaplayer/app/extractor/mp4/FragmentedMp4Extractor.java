...
import static com.mediaplayer.app.extractor.mp4.BoxParser.parseTraks;
import static com.mediaplayer.app.extractor.mp4.MimeTypeResolver.getContainerMimeType;
...
public class FragmentedMp4Extractor implements Extractor {
  ...
  private static void parseTraf(
    ...
    trackBundle.currentlyInFragment = true;
     LeafBox tfdtAtom = traf.getLeafBoxOfType(Mp4Box.TYPE_tfdt);
    ...
    TrackEncryptionBox encryptionBox =
     ...
     LeafBox saiz = traf.getLeafBoxOfType(Mp4Box.TYPE_saiz);
    if (saiz != null) {
      parseSaiz(checkNotNull(encryptionBox), saiz.data, fragment);
    }

     LeafBox saio = traf.getLeafBoxOfType(Mp4Box.TYPE_saio);
    if (saio != null) {
      parseSaio(saio.data, fragment);
    }

     LeafBox senc = traf.getLeafBoxOfType(Mp4Box.TYPE_senc);
    if (senc != null) {
  ...
  private static void parseSampleGroups(
      ContainerBox traf,  String schemeType, TrackFragment out) throws ParserException {
