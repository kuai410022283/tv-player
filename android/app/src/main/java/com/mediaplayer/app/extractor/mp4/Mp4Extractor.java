...
import static com.mediaplayer.app.extractor.mp4.Sniffer.BRAND_HEIC;
import static com.mediaplayer.app.extractor.mp4.Sniffer.BRAND_QUICKTIME;
  ...
  private boolean readAtomHeader(ExtractorInput input) throws IOException {
    ...
    if (atomSize == Mp4Box.DEFINES_LARGE_SIZE) {
      ...
      if (endPosition == C.LENGTH_UNSET) {
         ContainerBox containerAtom = containerAtoms.peek();
